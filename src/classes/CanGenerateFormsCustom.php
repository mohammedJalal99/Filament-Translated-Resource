...
namespace MohammedHamad\TranslatedResource\classes;
use Illuminate\Support\Str;
use MohammedHamad\TranslatedResource;

trait CanGenerateFormsCustom
{
    protected function getResourceFormSchema(string $model): string
    {
        ...
        foreach ($schema->getColumns($table) as $column) {
            ...
            $componentData['type'] = match (true) {
                $type['name'] === 'boolean' => TranslatedResource\Forms\Components\Toggle::class,
                $type['name'] === 'date' => TranslatedResource\Forms\Components\DatePicker::class,
                in_array($type['name'], ['datetime', 'timestamp']) => TranslatedResource\Forms\Components\DateTimePicker::class,
                $type['name'] === 'text' => TranslatedResource\Forms\Components\Textarea::class,
                $columnName === 'image', str($columnName)->startsWith('image_'), str($columnName)->contains('_image_'), str($columnName)->endsWith('_image') => TranslatedResource\Forms\Components\FileUpload::class,
                default => TranslatedResource\Forms\Components\TextInput::class,
            };
            ...
            if (str($columnName)->endsWith('_id')) {
                ...
                if (filled($guessedRelationshipName)) {
                    ...
                    $componentData['type'] = TranslatedResource\Forms\Components\Select::class;
            ...
            if ($componentData['type'] === TranslatedResource\Forms\Components\TextInput::class) {
            ...
            if ($componentData['type'] === TranslatedResource\Forms\Components\FileUpload::class) {
                $componentData['image'] = [];
            }
            ...
            if (in_array($type['name'], [
                ...
                if (in_array($columnName, [
                    ...
                    TranslatedResource\Forms\Components\TextInput::class,
                    TranslatedResource\Forms\Components\Textarea::class,
                ]) && isset($type['length'])) {
            ...
            if ($componentData['type'] === TranslatedResource\Forms\Components\Textarea::class) {
